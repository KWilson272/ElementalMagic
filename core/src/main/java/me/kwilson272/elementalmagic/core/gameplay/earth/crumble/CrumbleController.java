...
public class CrumbleController extends CoreAbilityController {

    protected static final String CONFIG_PATH = "Abilities.Earth.Crumble.";

    @Configure(path = CONFIG_PATH + "Description", config = Config.LANGUAGE)
    private String description = "Crumble the earth around you into tiny pieces of sand!";
    @Configure(path = CONFIG_PATH + "Instructions", config = Config.LANGUAGE)
    private String instructions = "Left-click to create sand around a target";

    public CrumbleController() {
        ElementalMagicApi.configManager().configure(this);
        ElementalMagicApi.configManager().configure(Crumble.CONFIG);
    }
    ...
    private Collection<Ability> handleAction(AbilityUser user,
        ...
        if (canActivateBy(activation.action())
            ...
            return List.of(new Crumble(user, this));        
        }
        return List.of();
    }
