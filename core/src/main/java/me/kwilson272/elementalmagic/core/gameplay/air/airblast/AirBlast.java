...
public class AirBlast extends AirAbility {
	...
	public AirBlast(AbilityUser user, AbilityController controller, boolean isSneak) {
    ...
    private class AirBlastRay extends Ray {
    
        private final Vector direction;

        public AirBlastRay(Location location, Vector direction) {
    ...
    protected static class ConfigValues {
        ...
        private static final String CONFIG_PATH = AirBlastController.CONFIG_PATH;
