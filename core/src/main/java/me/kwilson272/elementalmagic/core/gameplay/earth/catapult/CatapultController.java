...
public class CatapultController extends CoreAbilityController {

    protected static final String CONFIG_PATH = "Abilities.Earth.Catapult.";

    @Configure(path = CONFIG_PATH + "Description", config = Config.LANGUAGE)
    private String description = "Use the earth behind you to propel yourself forward.";
    @Configure(path = CONFIG_PATH + "Instructions", config = Config.LANGUAGE)
    private String instructions = "Left-Click while looking up.";

    public CatapultController() {
        ElementalMagicApi.configManager().configure(this);
        ElementalMagicApi.configManager().configure(Catapult.CONFIG);
    }
    ...
    private Collection<Ability> handleAction(AbilityUser user,
        ...
        if (canActivateBy(activation.action())
            ...
            return List.of(new Catapult(user, this)); 
        }
        return List.of();
    } 
