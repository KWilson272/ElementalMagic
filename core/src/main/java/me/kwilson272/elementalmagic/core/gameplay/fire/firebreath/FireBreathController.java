...
public class FireBreathController extends CoreAbilityController {
    ...
    public FireBreathController() {
        ...
        ElementalMagicApi.configManager().configure(FireBreath.CONFIG);
    }
    ...
    private Collection<Ability> handleAction(AbilityUser user,
        ...
        if (canActivateBy(activation.action()) 
            ...
            return List.of(new FireBreath(user, this));
        }
        return List.of();
    }
